...
def main():
    ...
    log_filename = "/home_data/home/wangyb12023/result/fMRI/wd0.0001_output_{}.log".format(
        ...
        for epoch in tqdm(range(200), file=f):
            ...
            with torch.no_grad():
                ...
                if accuracy > 60 and sens > 0.6 and spec > 0.6 and auc >= auc_baseline:
                    ...
                    torch.save(state, f'/home_data/home/wangyb12023/result/fMRI/qualified_model_{len(qualified)}_BASE_1_4_14_wd0.001.pth')
