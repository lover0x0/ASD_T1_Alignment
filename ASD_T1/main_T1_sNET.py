...
def main():
    ...
    log_filename = "/home_data/home/wangyb12023/result/T1/sNet_output_{}.log".format(
        ...
        for epoch in tqdm(range(200), file=f):
            ...
            with torch.no_grad():
                ...
                if accuracy > 60 and sens > 0.6 and spec > 0.6 and auc >= auc_baseline:
                    ...
                    torch.save(state, f'/home_data/home/wangyb12023/result/T1/qualified_model_{len(qualified)}_BASE_1_4_16_sNet.pth')
...
# 在绘图之前，添加一个正确的epoch范围
    ...
    plt.xlabel('Epoch')
    plt.ylabel('Accuracy')
    plt.title('sNet_Train and Validation Accuracy')
    plt.legend()
